...
APP_KEY = 'NKrYEecV5X6BuK5mr2unE7hFj' # API Key
APP_SECRET = 'PKJyuwON1Hfm69kPzR9PuIb72FTstrIkFvMUC07sJgtWG5iM05' # API Secret Key
OAUTH_TOKEN = '1450729853116825603-N2B0EOLY7JFSDyFMMb6XXhRQRev07T' # Access Token
OAUTH_TOKEN_SECRET = 'zvWb7QeobwrsmIV1xvUm9tTEZclfSk9RAfoWO032fJSMm' # Access Token Secret
...
def get_data_user_timeline_all_pages(kid, page):
 ...
 utilizando este método API.
        '''
        d = twitter.get_user_timeline(screen_name=kid, count="250", page=page, include_entities="true", include_rts="1")
...
dbStringConnection = "mongodb://JuanDuenez:Mecanica20@ac-va3gume-shard-00-00.sen2bjz.mongodb.net:27017,ac-va3gume-shard-00-01.sen2bjz.mongodb.net:27017,ac-va3gume-shard-00-02.sen2bjz.mongodb.net:27017/?ssl=true&replicaSet=atlas-dzaa64-shard-0&authSource=admin&retryWrites=true&w=majority"


dbName = '11MBIDJuanDuenez'
dbCollectionA = 'TwitterActCuentas'
dbCollectionT = 'TweetsAct'
...
for s in twitter_accounts[:len(twitter_accounts)]:
    ...
    while page < 16:
        ...
        for entry in d:
            ...
            now = datetime.now()
            loaded_entry.update({'Fecha y hora': now, 'Usuario:': 'Juan Duenez'})
        ...
        if rate_limit < 5:
            ...
            if rate_limit_check<5:
                ...
                time.sleep(30) #PAUSA DE 300 SEGUNDOS
                rate_limit = twitter.get_application_rate_limit_status()['resources']['statuses']['/statuses/user_timeline']['remaining']
    ...
    if rate_limit < 5:
        ...
        time.sleep(30) #PAUSA POR 300 SEGUNDOS
